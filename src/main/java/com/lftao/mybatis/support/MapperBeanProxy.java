...
public class MapperBeanProxy<T> extends MapperFactoryBean<T> implements FactoryBean<T> {
    private Class<T> mapperInterface;

    public MapperBeanProxy() {
        super();
    }

    public MapperBeanProxy(Class<T> mapperInterface) {
